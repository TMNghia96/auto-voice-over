...
exports.timeToSeconds = exports.optimizeSrtFile = exports.optimizeSrt = exports.stringifySrt = exports.parseSrt = exports.msToTime = void 0;
 ...
 */
const interpolateTime = (startMs, endMs, charPos, totalChars) => {
    if (totalChars <= 0)
        return startMs;
...
const stringifySrt = (entries) => {
    return entries.map(entry => {
        return `${entry.index}\n${entry.startTime} --> ${entry.endTime}\n${entry.text}\n`;
    }).join('\n');
};
exports.stringifySrt = stringifySrt;
/**
 ...
 */
const optimizeSrt = (srtContent) => {
    const originalSegments = (0, exports.parseSrt)(srtContent);
    ...
    for (const seg of mergedSegments) {
        ...
        if (duration > MAX_SEGMENT_DURATION_MS_SPLIT && seg.text.length > 50) {
            ...
            if (bestSplitIdx > 0 && bestSplitIdx < text.length) {
                ...
                splitSegments.push({
                    ...seg,
                    endTime: (0, exports.msToTime)(splitTimeMs),
                    text: part1
                });
                splitSegments.push({
                    index: 0,
                    startTime: (0, exports.msToTime)(splitTimeMs + 1),
                    endTime: seg.endTime,
                    text: part2
                });
            }
    ...
    for (let j = 0; j < magnetSegments.length; j++) {
        ...
        if (duration < 1000) {
            ...
            curr.startTime = (0, exports.msToTime)(currStartMs);
            curr.endTime = (0, exports.msToTime)(currEndMs);
        }
...
exports.optimizeSrt = optimizeSrt;
/**
 * Optimize an SRT file in place
 */
const optimizeSrtFile = (srtPath) => {
    const content = fs_1.default.readFileSync(srtPath, 'utf-8');
    const optimized = (0, exports.optimizeSrt)(content);
    fs_1.default.writeFileSync(srtPath, optimized, 'utf-8');
    return optimized;
};
exports.optimizeSrtFile = optimizeSrtFile;
...
//# sourceMappingURL=SrtOptimizer.js.map